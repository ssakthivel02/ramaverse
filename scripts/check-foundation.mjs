...
if (!canonical.includes('approved !== true')) fail("canonical approval gate is missing");
if (fs.existsSync("public/data/canonical-manifest.json")) fail("canonical manifest must not be pre-approved in foundation stage");
